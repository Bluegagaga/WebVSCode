...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        // viewport
        var head = $('head');
        var ua = navigator.userAgent.toLocaleLowerCase(), regV = /ipod|ipad|iphone/gi, result = ua.match(regV),
            userScale = "";
        if (!result) {
    ...
    $(document).ready(function () {
        $('#menu>li.menu-item-has-children:has(ul)').addClass('is-dropdown-submenu-parent');
    });
})(jQuery);
